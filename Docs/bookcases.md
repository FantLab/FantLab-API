...
/my/bookcases/*  
"/my/" - зона API, выделенная для работы пользователям со своими личными данными. Тут, в отличие от роутов библиобазы тут при построении урлов используется логика items/id/action и множественное число
