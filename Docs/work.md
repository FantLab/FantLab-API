...
```
{
    ...
    classificatory: [                  # массив классификации произведения
        {
            total_count: Int,              # кол-во сделано классификаций от юзеров
...
Пример
```
/GET /work92/ajaxsetmark10towork1 - поставить оценку 10 "Гипериону" Дэна Симмонса со страницы цикла "Песни Гипериона"
```
Ответ
```
{
